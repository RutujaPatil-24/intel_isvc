...
//-------------Technical BulkUpload----------
	...
	public void upload_bulk_file(String string) throws AWTException, InterruptedException {
		...
		Robot upload = new Robot();
		upload.delay(2000);
		StringSelection stringSelection = new StringSelection("C:\\Users\\oyadavx\\OneDrive - Intel Corporation\\Desktop\\ULT Bulk Upload Sheet\\MMCPN_BulkUploadTemplate (3).csv");
		Toolkit.getDefaultToolkit().getSystemClipboard().setContents(stringSelection, null);
		upload.keyPress(KeyEvent.VK_CONTROL); // Key Press On key Board
		upload.keyPress(KeyEvent.VK_V);
		upload.delay(2000);
...
//-----------------NPR BulkIpload with ULT
	...
	public void click_on_create_button_and_select_remedy_and_select_reason_customer_site_sold_to(String string) throws InterruptedException {
...
//Select First Address for all
	...
	public void print_case_no_into_console_sr() {
      Technical = new Technical(driver);
